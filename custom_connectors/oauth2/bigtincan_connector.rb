      ...
      fields: - > (connection, config_fields) {
        [{
          ...
          },
          {
            name: 'data',
            type:: object,
            properties: if config_fields['form_id'].present ?
    ...
    get_form_data: {
      ...
      output_fields: - > (object_definitions) {
        [{
          ...
          {
            name: 'submission_next_page',
            type: 'integer'
          },
          {
            name: 'submission_prev_page',
            type: 'integer'
          },
          {
            name: 'submissions',
            type:: array,
            of:: object,
            properties: object_definitions['form_submission_data']
          }
        ]
      }
    },
